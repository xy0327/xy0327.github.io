<template>
  <div>
    <mt-header title="男生频道" style="background-color:#fff;color:#000">
...
export default {
  ...
  created() {
    this.$http
      .get(
        "http://read.xiaoshuo1-sm.com/novel/i.php?do=is_caterank&p=1&page=1&words=&shuqi_h5=&onlyCpBooks=1&firstCate=%E7%8E%84%E5%B9%BB&sort=monthHot&_=1582377244025",
        {
          params: {
           do: "is_caterank",
              p: 1,
